...
export class InnerScreen extends React.Component {
  ...
  render() {
    ...
    if (enabled && isNativePlatformSupported) {
      ...
      const AnimatedScreen = Platform.OS === 'android' || stackPresentation === 'push' || stackPresentation === 'containedModal' || stackPresentation === 'containedTransparentModal' ? AnimatedNativeScreen : AnimatedNativeModalScreen;
      let {
